...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'ibm-cloud-developer:build': () => this.build(),
      'ibm-cloud-developer:build.release': () => this.buildForRelease(),
  ...
  deploy() {
    this.showUI();
    new SystemCommand(["ibmcloud", "dev", "deploy"], this.ibmDeveloperExtensionAtomView).execute();
    return true;
  },
